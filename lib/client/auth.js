...
if (Meteor.settings
	...
	&& Meteor.settings.public.fastRender
	&& Meteor.settings.public.fastRender.cookies) {
	secure = Meteor.settings.public.fastRender.cookies.secure;
	domain = Meteor.settings.public.fastRender.cookies.domain;
	SameSite = Meteor.settings.public.fastRender.cookies.SameSite;
}
